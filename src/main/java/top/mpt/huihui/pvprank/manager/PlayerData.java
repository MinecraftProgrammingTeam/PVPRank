...
public class PlayerData {
    ...
    private final Integer teamId;   // 改为 Integer
    ...
    public PlayerData(String uuid, String playerName, Integer teamId, long personalScore,
    ...
    public String getOpponentUuid() { return opponentUuid; }
}